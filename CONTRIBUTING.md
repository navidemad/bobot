...
[issues]: https://github.com/navidemad/bobot/issues

## Submitting an Issue

If you're confident that you've found a bug in
bobot, please [open an issue][issues], but check to make sure it hasn't
...
4. Run `bundle exec rspec`. If your specs pass, return to step 3.
5. Implement your feature or bug fix.
6. Run `bundle exec rspec`. If your specs fail, return to step 5.
